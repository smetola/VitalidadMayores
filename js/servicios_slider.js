/**
 * Servicios Slider - Convierte la sección de servicios en un slider para dispositivos móviles
 */
document.addEventListener('DOMContentLoaded', () => {
  ...
  const slides = Array.from(document.querySelectorAll('.servicio-card'));
  ...
  function activateSlider() {
    ...
    sliderWrapper.classList.add('servicios-slider-wrapper');
    ...
    // 4. Reemplazar el grid con el wrapper
    grid.parentNode.insertBefore(sliderWrapper, grid);
  ...
  function deactivateSlider() {
    ...
    // 1. Restaurar slides al grid original
    slides.forEach((slide, index) => {
      ...
      // Devolver a la cuadrícula original
      grid.appendChild(slide);
    });
    
    // 2. Restaurar cuadrícula original
    grid.style.display = originalStyles.grid.display;
    ...
    // 6. Restaurar estilos del contenedor
  ...
  function createNavigation() {
    ...
    dotsContainer.classList.add('servicios-slider-dots');
    ...
    slides.forEach((_, index) => {
      ...
      dot.classList.add('servicios-slider-dot');
    ...
    prevButton.classList.add('servicios-slider-prev');
    prevButton.setAttribute('aria-label', 'Anterior servicio');
    ...
    nextButton.classList.add('servicios-slider-next');
    nextButton.setAttribute('aria-label', 'Siguiente servicio');
  ...
  function goToSlide(index) {
    ...
    if (dotsContainer) {
      const dots = dotsContainer.querySelectorAll('.servicios-slider-dot');
      dots.forEach((dot, i) => {
